...
class TestUpdatePostUseCase:
    ...
    async def test_update_post_use_case_with_related_data_Exception(self):
        repository.get_by_id_dict.side_effect = lambda *args, **kwargs: {"user_id": 1}
    ...
    async def test_update_post_use_case_with_related_data_success(self):
        repository.update_with_related.side_effect = lambda *args, **kwargs: {
            "id": 1,
            "name": new_data.name,
            "html": new_data.html,
            "user_id": 1,
